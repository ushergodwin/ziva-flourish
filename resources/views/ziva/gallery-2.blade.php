...
<head>
    ...
    <title>Beautyhouse | Gallery 2</title>
            ...
            <div class="gallery-isotope-section">
                <div class="container">
                        ...
                        <div class="col-md-12">
                            <div class="gallery-tab-menu isotope-menu text-center">   
                                <ul>
									...
									<li data-filter=".massage">Lunch</li>
									<li data-filter=".skin">skin care</li>
									<li data-filter=".hair">hair cut</li>
									<li data-filter=".nail">nail care</li>
									<li data-filter=".beauty"> beauty spa</li>
								</ul>
                            </div>
                        </div>
                    </div>
                    <div class="gallery-tab-content isotope-gallery">
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-xs-12 skin hair beauty gallery-item">
                                <div class="single-gallery">
                                    <div class="gallery-img">
                                        <img src="images/gallery/item2/1.jpg" alt="">
                                        <a href="images/gallery/item2/1.jpg"><i class="zmdi zmdi-zoom-in"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-xs-12 massage skin nail gallery-item">
                                <div class="single-gallery">
                                    <div class="gallery-img">
                                        <img src="images/gallery/item2/2.jpg" alt="">
                                        <a href="images/gallery/item2/2.jpg"><i class="zmdi zmdi-zoom-in"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-xs-12 skin hair nail gallery-item">
                                <div class="single-gallery">
                                    <div class="gallery-img">
                                        <img src="images/gallery/item2/3.jpg" alt="">
                                        <a href="images/gallery/item2/3.jpg"><i class="zmdi zmdi-zoom-in"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-xs-12 massage skin beauty gallery-item">
                                <div class="single-gallery">
                                    <div class="gallery-img">
                                        <img src="images/gallery/item2/4.jpg" alt="">
                                        <a href="images/gallery/item2/4.jpg"><i class="zmdi zmdi-zoom-in"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-xs-12 skin skin nail gallery-item">
                                <div class="single-gallery">
                                    <div class="gallery-img">
                                        <img src="images/gallery/item2/5.jpg" alt="">
                                        <a href="images/gallery/item2/5.jpg"><i class="zmdi zmdi-zoom-in"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-xs-12 massage hair beauty gallery-item">
                                <div class="single-gallery">
                                    <div class="gallery-img">
                                        <img src="images/gallery/item2/2.jpg" alt="">
                                        <a href="images/gallery/item2/2.jpg"><i class="zmdi zmdi-zoom-in"></i></a>
